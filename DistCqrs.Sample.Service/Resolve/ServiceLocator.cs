...
namespace DistCqrs.Sample.Service.Resolve
{
    public class ServiceLocator : IServiceLocator
    {
        ...
        public ICommandHandler<TRoot, TCmd> ResolveCommandHandler<TRoot, TCmd>() where TRoot : IRoot, new() where TCmd : ICommand
        {
        ...
        public IEventHandler<TRoot, TEvent> ResolveEventHandler<TRoot, TEvent>() where TRoot : IRoot, new() where TEvent : IEvent<TRoot>
        {
